...
public class StudentDAO extends HttpServlet {
    ...
    public int register(Student stud)   {
    	...
    	try {
    	 ...
    	 /*SessionFactory sessionFactory=new Configuration().configure("/webapp/WEB-INF/hibernate.cfg.xml").buildSessionFactory();
    	//SessionFactory sessionFactory = new Configuration().configure("hibernate.cfg.xml").addAnnotatedClass(clima.class).buildSessionFactory();
